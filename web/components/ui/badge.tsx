  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        phoneScreen: "border-transparent bg-amber-100 text-amber-700",
        interview: "border-transparent bg-purple-100 text-purple-700",
        offer: "border-transparent bg-emerald-100 text-emerald-700",
